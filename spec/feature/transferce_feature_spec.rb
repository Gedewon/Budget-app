...
RSpec.describe TransfercesController, :type => :feature do
    before(:example) do 
        @user =User.first || User.create(name:'testname',email:'testname@testdomain.com',password:"somerandompassword")
